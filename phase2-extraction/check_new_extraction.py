...
if found >= 8:
    print(f"   ✅ EXCELLENT - Text is readable")
else:
...
if multi_space == 0 and tabs == 0 and found >= 8:
    print(f"✅ EXCELLENT QUALITY - Ready for Phase 3!")
elif found >= 8:
    print(f"⚠️  GOOD QUALITY - Minor issues but usable")
else:
    print(f"❌ POOR QUALITY - Extraction failed")
