...
if not validation_backup.exists():
    ...
    print(f"✓ Phase 1 backup already exists")
...
if '"file_path":' in phase1_content:
    ...
    if import_line in phase1_content:
        ...
        update_line = 'data["phase1"]["files"][file_id].update(metadata.model_dump())'
        ...
        if update_line in phase1_content:
            ...
            new_call = 'merge_to_json(metadata, args.json_path, file_id, args.file)'
            ...
            if old_call in phase1_content:
                ...
                print("⚠️  Could not find merge_to_json call - manual fix needed")
        else:
...
if "installed" not in check_result.stdout:
    ...
    if install_result.returncode == 0:
        ...
        print("   Please run manually: cd phase2-extraction && poetry add pypdf")
else:
...
if result.returncode != 0:
    print("\n❌ Processing failed")
    print("\nTroubleshooting:")
    print("  1. Check Phase 1 module: cd phase1-validation && poetry run python -m phase1_validation.validation --help")
    print("  2. Check Phase 2 module: cd phase2-extraction && poetry run python -m phase2_extraction.extraction --help")
    print("  3. Check pypdf: cd phase2-extraction && poetry run python -c 'import pypdf'")
    sys.exit(1)
