...
print(f"Multi-pass - multi-space issues in first 2000 chars: {multipass_spaces}")
...
multipass_norm_spaces = len(re.findall(r'  +', multipass_norm_info['beginning']))
...
if multipass_norm_size > existing_norm_size and multipass_norm_spaces <= existing_norm_spaces:
    ...
    print(f"   Reason: Better quality ({existing_norm_spaces} vs {multipass_norm_spaces} issues)")
