...
def extract(path: Path, batch_size: int = 10) -> Tuple[str, Dict]:
    ...
    try:
        ...
        while True:
            ...
            logger.info(f"Converting pages {page_num+1}-{page_num+batch_size} to images...")
            ...
            for i, img in enumerate(images):
                ...
                try:
                    ...
                    if page_confidences:
                        ...
                        logger.warning(f"  Page {current_page}: No text detected")
        ...
        metadata = {
            ...
            "ocr_confidence_min": min(all_confidences) if all_confidences else 0.0,
            "ocr_confidence_max": max(all_confidences) if all_confidences else 0.0,
            "tool_used": "easyocr"
        }
