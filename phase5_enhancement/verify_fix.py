...
def verify_config():
    ...
    print(
        f"  Volume Normalization: {config.get('enable_volume_normalization')}"
    )
    ...
    if all_good:
        ...
        print("Next steps:")
        print(
            "1. Test single chunk: poetry run python src/phase5_enhancement/main.py --chunk_id 0 --skip_concatenation"
        )
