...
def generate_subtitles(
    ...
    logger.info("Transcribing... (this may take 30-60 minutes for full audiobook)")
    ...
    for i, segment in enumerate(segments, start=1):
        ...
        if i % 100 == 0:
            logger.info(f"  Processed {i} segments... ({segment.start/60:.1f} minutes)")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Generate subtitles for audiobook")
    parser.add_argument("--input", required=True, help="Input audio file (MP3, WAV)")
    parser.add_argument("--output", help="Output SRT file (default: input_name.srt)")
