#!/usr/bin/env python3
"""Test the minimal version with clean chunk 2 text (manual helper)."""
...
def main() -> int:
    ...
    chunk2_file = Path(
        "../phase3-chunking/chunks/The Analects of Confucius_20240228_chunk_002.txt"
    )
    ...
    pipeline.setdefault("phase3", {}).setdefault("files", {})[test_id] = {
    ...
    cmd = [
        ...
        "--no-capture-output",
        "python",
        "src/phase4_tts/main_minimal.py",
        "--chunk_id=0",
        f"--file_id={test_id}",
