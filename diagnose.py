...
if chunks_dir.exists():
    ...
    if txt_files:
        ...
        if 'meditations' in sample.lower():
            ...
            print("  ❌ First chunk appears to be Gift of the Magi - WRONG BOOK!")
else:
...
if phase4_files:
    ...
    print(f"  First 3 audio file IDs:")
...
p3_base = list(phase3_files.keys())[0].rsplit('_c', 1)[0] if phase3_files else None
