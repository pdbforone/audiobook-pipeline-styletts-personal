...
chunk_file = Path(
    "../phase3-chunking/chunks/The Analects of Confucius_20240228_chunk_001.txt"
)
...
def analyze_text(text, label):
    ...
    print(
        f"  Newlines: {newline_count} ({newline_count/len(text)*100:.1f}% of text)"
    )
...
if problems:
    ...
    print("\n📋 CONCLUSION:")
    print(
        "  The gibberish audio is caused by BAD TEXT INPUT, not Phase 4 code."
    )
    print(
        "  Phase 4 is working correctly - it's synthesizing exactly what it reads."
    )
