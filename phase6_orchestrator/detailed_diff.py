...
# Read Phase 2 text
phase2_path = Path("../phase2-extraction/extracted_text/The_Analects_of_Confucius_20240228.txt")
with open(phase2_path, 'r', encoding='utf-8') as f:
    phase2_text = f.read()

# Read all Phase 3 chunks
chunks_dir = Path("../phase3-chunking/chunks")
chunk_files = sorted(chunks_dir.glob("The_Analects_of_Confucius_20240228_chunk_*.txt"))
...
if p2_norm == p3_norm:
    ...
    differences = [(i, line) for i, line in enumerate(diff) if line.startswith('- ') or line.startswith('+ ')]
