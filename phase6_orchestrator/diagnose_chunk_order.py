...
def main():
    ...
    console.print("[yellow]1. Pipeline JSON - Phase 4 chunk_audio_paths order[/yellow]")
    ...
    console.print(f"  📝 First 10 files: {[f.name for f in magi_audio_files[:10]]}")
    ...
    if enhanced_files:
        ...
        console.print(f"  📝 First 10: {[f.name for f in enhanced_files[:10]]}")
        ...
        is_enhanced_sorted = enhanced_chunk_numbers == sorted(enhanced_chunk_numbers)
    ...
    if not is_sorted:
        ...
        console.print("concatenation logic (ThreadPoolExecutor completion order).")
