        ...
        if chunk_paths:
            ...
            if first_path.is_absolute():
                ...
                if first_path.exists():
                    print("  ✓ First chunk file EXISTS")
                else:
                    print("  ✗ First chunk file NOT FOUND")
            else:
                print("  ⚠ Paths are RELATIVE (problem!)")
                ...
                for base_path in possible_bases:
                    ...
                    print("  ✗ Could not find chunk files")
        print()
...
if files:
    ...
    print('python orchestrator.py "your_file.pdf" --phases 4')
