...
def main():
    ...
    console.print(f"[yellow]Current Phase 4 files:[/yellow]")
    ...
    if len(files) == 1:
        ...
        if "phase5" in data:
            console.print(f"  🗑️  Clearing old Phase 5 data")
            data.pop("phase5")
        ...
        console.print(f"  • Kept Gift of Magi ({len(magi_data.get('chunk_audio_paths', []))} chunks)")
        console.print(f"  • Cleared Phase 5 data")
