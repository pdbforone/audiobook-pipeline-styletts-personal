...
def main():
    ...
    main_py = project_root / "phase5_enhancement" / "src" / "phase5_enhancement" / "main.py"
    ...
    if original_validation in content:
        ...
        console.print("[yellow]⚠[/yellow]  Patch 1: Pattern not found (may already be patched)")
    ...
    if original_clipping in content:
        ...
        console.print("[yellow]⚠[/yellow]  Patch 2: Pattern not found (may already be patched)")
    ...
    if original_fallback_reject in content:
        content = content.replace(original_fallback_reject, patched_fallback_reject)
        console.print("[green]✓[/green] Patch 3: Remove final rejection")
    else:
        console.print("[yellow]⚠[/yellow]  Patch 3: Pattern not found (may already be patched)")
    ...
    console.print("[yellow]All 637 chunks will be accepted regardless of quality.[/yellow]")
