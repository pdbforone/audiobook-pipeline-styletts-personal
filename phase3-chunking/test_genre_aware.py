...
def test_profiles():
    ...
    try:
        from phase3_chunking.profiles import list_profiles, get_profile_info
...
def test_genre_detection():
    ...
    try:
        ...
        genre, confidence, scores = detect_genre(
            philosophy_text, {"title": "The Analects"}
        )
        print("\nPhilosophy text:")
        ...
        if (
            genre == "fiction" or confidence > 0.3
        ):  # May detect as fiction or memoir
